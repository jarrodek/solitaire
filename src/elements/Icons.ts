...
export const iconWrapper = (tpl: SVGTemplateResult, width = 24, height = 24, viewBox: {x?: number, y?: number, width?: number, height?: number} = { x: 0, y: 0, width, height }): SVGTemplateResult => {
  ...
  return svg`<svg 
    ...
    focusable="false" 
    style="pointer-events: none; display: block; width: ${width}px; height: ${height}px; fill: currentColor;">${tpl}</svg>`;
}

export type IconType = 'refresh' | 'undo' | 'redo' | 'settings' | 'close' | 'bolt' | 'volumeUp' | 'volumeOff' | 'lightbulb' | 'trophy' | 'menu';
...
export const trophy = iconWrapper(svg`<path d="M280-120v-80h160v-126q-60-12-106-53t-64-101H160q-33 0-56.5-23.5T80-560v-120q0-33 23.5-56.5T160-760h120v-80h400v80h120q33 0 56.5 23.5T880-680v120q0-33-23.5-56.5T800-480h-110q-18 60-64 101t-106 53v126h160v80H280Zm-120-440h110v-120H160v120Zm530 0h110v-120H690v120ZM360-480h240q0-50-35-85t-85-35q-50 0-85 35t-35 85Z"/>`, undefined, undefined, { y: -960, width: 960, height: 960 });
export const menu = iconWrapper(svg`<path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/>`, undefined, undefined, { y: -960, width: 960, height: 960 });
